...
document.addEventListener('DOMContentLoaded', () => {
    // Smooth scroll para a seção de funcionalidades
    ...
    setTimeout(() => {
        ...
        if (heroParagraph) heroParagraph.classList.add('fade-in-up', 'delay-0-3s');
        if (heroButton) heroButton.classList.add('fade-in-up', 'delay-0-6s');
    ...
    if (logo) { // Garante que o logo existe
